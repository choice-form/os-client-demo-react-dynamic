const enUS: ILang = {
  ...
  preview: {
    ...
    time: {
      ...
      about: 'About time',
      detail: 'Most users employ Timing in conjunction with other questions. For example, if you have a Matrix Table question, you might record how long a respondent is spending on the page, and if they don’t spend long enough, use a Branch element to screen them out of the survey.',
